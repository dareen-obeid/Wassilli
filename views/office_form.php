...
<html lang="en">
  <head>
    ...
    <title>Wassilli- add new office</title>
    <!-- endinject -->
  ...
  <body>
     ...
     <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-4 jumbotron my-5">
           <h4 class="text-center my-2">Add New office</h4>
           ...
           <label>city</label>
             ...
             <input type="submit" id="create" name="add_user_office" class="btn btn-success my-2" value="Add office" >
        ...
        <div class='sticky-top invisible' id="greenalert">
            ...
            <strong>You have successfully add new office. </strong>Check offices table.
        ...
        <div class='alert alert-warning alert-dismissible fade show' role='alert'>
            <strong>Faild to add new office. </strong>Please Fill all the feilds.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit','#officeForm',function(event){
                    event.preventDefault();
                    $.ajax({
                        type: 'post',
                        url: "./../controlers/add_office.php", cache: false, timeout: 2000,
                        data: $('form').serialize(),
                        success:function(){
                            $('#greenalert').removeClass('invisible');
                            $('#greenalert').addClass('visible');
                            $( '#officeForm' ).each(function(){
                                this.reset();
                            });
                        },
