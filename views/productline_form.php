...
<html lang="en">
  <head>
    ...
    <title>Wassilli- add new productline</title>
    <!-- endinject -->
  ...
  <body>
     ...
     <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-4 jumbotron my-5">
           <h4 class="text-center my-2">Add New productline</h4>
           <form method="POST" id="productlineForm">
             
             <label>product Line</label>
             <input type="text" name="productLine" class="form-control" autocomplete="off" required>

             <label>text Description</label>
             <input type="text" name="textDescription" class="form-control" autocomplete="off" required>

            
             
             <input type="submit" id="create" name="add_user_productline" class="btn btn-success my-2" value="Add productline" >
        ...
        <div class='sticky-top invisible' id="greenalert">
            ...
            <strong>You have successfully add new productline. </strong>Check productlines table.
        ...
        <div class='alert alert-warning alert-dismissible fade show' role='alert'>
            <strong>Faild to add new productline. </strong>Please Fill all the feilds.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit','#productlineForm',function(event){
                    event.preventDefault();
                    $.ajax({
                        type: 'post',
                        url: "./../controlers/add_productline.php", cache: false, timeout: 2000,
                        data: $('form').serialize(),
                        success:function(){
                            $('#greenalert').removeClass('invisible');
                            $('#greenalert').addClass('visible');
                            $( '#cproductlineForm' ).each(function(){
                                this.reset();
                            });
                        },
