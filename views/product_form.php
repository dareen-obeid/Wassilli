<?php
    ...
    $productlinesQuery = "SELECT * FROM `productlines`";
    $productlines = mysqli_query($connection, $productlinesQuery);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Wassilli- add new product</title>
    <!-- endinject -->
     ...
     <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-4 jumbotron my-5">
           <h4 class="text-center my-2">Add New produt</h4>
           <form method="POST" id="productForm">
             
             <label>Product Code</label>
             <input type="text" name="productCode" class="form-control" autocomplete="off" required>

             <label>Product Name</label>
             <input type="text" name="productName" class="form-control" autocomplete="off" required>

             <label class="mt-2">Product Line</label>
             <select name="productLine" id="productLine" class="form-control" default="choose productLine">
             <?php 
             ...
             <input type="text" name="productDescription" class="form-control" autocomplete="off" required>
             <label>Quantity In Stock</label>
             <input type="text" name="quantityInStock" class="form-control" autocomplete="off" required>
             <label>buyPrice</label>
             <input type="text" name="buyPrice" class="form-control" autocomplete="off" required>
             
             <input type="submit" id="create" name="add_user_product" class="btn btn-success my-2" value="Add Product" >
        ...
        <div class='sticky-top invisible' id="greenalert">
            ...
            <strong>You have successfully add new product. </strong>Check product table.
        ...
        <div class='alert alert-warning alert-dismissible fade show' role='alert'>
            <strong>Faild to add new product. </strong>Please Fill all the feilds.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on('submit','#productForm',function(event){
                    ...
                    $.ajax({
                        type: 'post',
                        url: "./../controlers/add_product.php", cache: false, timeout: 2000,
                        data: $('form').serialize(),
                        success:function(){
