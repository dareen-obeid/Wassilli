...
<html lang="en">
  <head>
    ...
    <title>Wassilli- add new payment</title>
    <!-- endinject -->
     ...
     <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-4 jumbotron my-5">
           <h4 class="text-center my-2">Add New payment</h4>
           <form method="POST" id="paymentForm">

           <label class="mt-2">customer Number</label>
             <select name="customerNumber" id="customerNumber" class="form-control" default="choose customerNumber">
                <?php 
             ...
             <input name="paymentDate" class="datepicker" data-date-format="yyyy-mm-dd">
             ...
             <input type="submit" id="create" name="add_user_payment" class="btn btn-success my-2" value="Add payment" >
        ...
        <div class='sticky-top invisible' id="greenalert">
            ...
            <strong>You have successfully add new payment. </strong>Check payments table.
        ...
        <div class='alert alert-warning alert-dismissible fade show' role='alert'>
            <strong>Faild to add new payment. </strong>Please Fill all the feilds.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit','#paymentForm',function(event){
                    ...
                    $.ajax({
                        type: 'post',
                        url: "./../controlers/add_payment.php", cache: false, timeout: 2000,
                        data: $('form').serialize(),
                        success:function(){
