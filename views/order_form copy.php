...
<html lang="en">
  <head>
    ...
    <title>Wassilli- add new order</title>
    <!-- endinject -->
       ...
       <div class="row">
         ...
         <div class="col-md-4 jumbotron my-5">
           ...
           <form method="POST" id="orderForm">
             ...
             <input name="orderDate" class="datepicker" data-date-format="yyyy-mm-dd">
        ...
        <div class='sticky-top invisible' id="greenalert">
            ...
            <strong>You have successfully add new order. </strong>Check orders table.
        ...
        <div class='alert alert-warning alert-dismissible fade show' role='alert'>
            <strong>Faild to add new order. </strong>Please Fill all the feilds.
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                <span aria-hidden='true'>&times;</span>
            </button>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit','#orderForm',function(event){
                    ...
                    $.ajax({
                        type: 'post',
                        url: "./../controlers/add_order.php", cache: false, timeout: 2000,
                        data: $('form').serialize(),
                        success:function(){
